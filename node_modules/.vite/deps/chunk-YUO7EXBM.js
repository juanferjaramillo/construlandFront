...
var SpeedDialAction = React2.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React2.useState(tooltipOpenProp);
  ...
  const fab = (0, import_jsx_runtime3.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime4.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
      className: classes.staticTooltip,
      ownerState
    }, other, {
      children: [(0, import_jsx_runtime3.jsx)(SpeedDialActionStaticTooltipLabel, {
        style: transitionStyle,
        id: `${id}-label`,
        className: classes.staticTooltipLabel,
        ownerState,
        children: tooltipTitle
      }), React2.cloneElement(fab, {
  ...
  return (0, import_jsx_runtime3.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
true ? SpeedDialAction.propTypes = {
   ...
   */
  TooltipClasses: import_prop_types2.default.object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: import_prop_types2.default.bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: import_prop_types2.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: import_prop_types2.default.node
} : void 0;
...
//# sourceMappingURL=chunk-YUO7EXBM.js.map
